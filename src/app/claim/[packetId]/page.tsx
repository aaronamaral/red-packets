            ...
            <div className="mt-6 max-w-sm">
              ...
              <p className="text-cream/60 text-sm">
                {error === "account_too_new"
                  ...
                  : error === "not_following_creator"
                  ? "Follow the creator on X to claim this packet."
                  : error === "not_following_coinbase"
                  ? "Follow @coinbase_au on X to claim this packet."
                  : error === "follow_check_failed"
                  ? "We couldn’t verify your follow status. Please try again."
                  : error === "rate_limited"
